...
namespace TheRideYouRent.Controllers
{
    public class InspectorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Inspector_no,Name,Email,Mobile")] Inspector inspector)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Inspector_no,Name,Email,Mobile")] Inspector inspector)
        {
            if (ModelState.IsValid)
            {
